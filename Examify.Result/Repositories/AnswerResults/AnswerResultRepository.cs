    ...
    : IAnswerResultRepository
{
    ...
    public async Task<bool> DeleteByOptionIds(List<Guid> ids)
    {
        quizResultContext.AnswerResults.RemoveRange(quizResultContext.AnswerResults.Where(x => ids.Contains(x.OptionId)));
