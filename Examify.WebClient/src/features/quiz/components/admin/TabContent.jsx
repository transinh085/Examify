...
const TabContent = ({ data }) => {
  ...
  if(data.length === 0) return (
    <Flex className="space-y-3" vertical>
      ...
      <Typography.Text className="text-center">Pull in questions from the Quizizz library or make your own. It’s quick and easy!</Typography.Text>
      <Flex justify="center">
        <Button loading={createQuizMutation.isPending} type="primary" className="font-bold text-lg" onClick={createQuizHandler}>Create a quiz</Button>
      </Flex>
    </Flex>
  );
   return (
