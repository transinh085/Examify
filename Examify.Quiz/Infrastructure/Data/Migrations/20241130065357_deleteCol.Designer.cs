...
namespace Examify.Quiz.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241130065357_deleteCol")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Examify.Quiz.Entities.QuizSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Examify.Quiz.Entities.QuizSetting", b =>
                {
                    b.HasOne("Examify.Quiz.Entities.Quiz", "Quiz")
                        .WithOne("Settings")
                        .HasForeignKey("Examify.Quiz.Entities.QuizSetting", "QuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
