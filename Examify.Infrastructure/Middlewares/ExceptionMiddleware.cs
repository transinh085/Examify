...
namespace Examify.Infrastructure.Middlewares;
...
public class ExceptionMiddleware : IMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        catch (Exception exception)
        {
            ...
            {
                FluentValidation.ValidationException fluentException =>
                    ExceptionDetails.HandleFluentValidationException(fluentException),
                UnauthorizedException unauthorizedException => ExceptionDetails.HandleUnauthorizedException(
